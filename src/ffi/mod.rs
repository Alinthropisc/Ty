...
unsafe extern "C" {
    ...
    pub fn ty_get_own_ipv6(iface: *const c_char, dst: *mut c_uchar, prefer: c_int) -> *mut c_uchar;

    #[link_name = "thc_get_multicast_mac"]
    pub fn ty_get_multicast_mac(dst: *mut c_uchar) -> *mut c_uchar;

    #[link_name = "thc_get_mac"]
    pub fn ty_get_mac(iface: *const c_char, src: *mut c_uchar, dst: *mut c_uchar) -> *mut c_uchar;
    ...
    pub fn ty_send_raw_pkt(iface: *const c_char, pkt: *mut c_uchar, pkt_len: *mut c_int) -> c_int;
    ...
    pub fn ty_pcap_check(p: *mut libc::c_void, func: *const c_char, opt: *mut c_char) -> c_int;
